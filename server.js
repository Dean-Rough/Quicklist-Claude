...
function stripEmojis(obj) {
  if (typeof obj === 'string') {
    ...
    return obj
      .replace(
        /[\u{1F300}-\u{1FAF0}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{1F1E6}-\u{1F1FF}\u{2B50}\u{1F004}-\u{1F0CF}\u{1F170}-\u{1F251}]/gu,
        ''
      )
      .replace(/\s{2,}/g, ' ')
      .trim();
...
function extractListingFromGeminiText(text) {
  ...
  return parsed ? stripEmojis(parsed) : null;
}
...
3. **Provide (based on label reading):**
    ...
    **Marketing Paragraph** (3-4 sentences):
     ...
     **WRITING STYLE RULES:**
     - Write from an OBSERVER perspective - describe what you see in the photos as a neutral third party
     - Use phrases like "appears to be", "shows", "features", "displays" rather than seller claims
     - Example: "The shoe sole appears to be in excellent, near-new condition with minimal to no visible signs of wear" NOT "I barely wore these"
     - Example: "The upper displays premium leather construction with visible grain texture" NOT "This is high quality leather"
     - Describe condition objectively: what is visible, what appears present or absent, what the photos show
     - Avoid seller language like "I'm selling", "my item", "I bought this", "I only wore"
     - Avoid generic phrases like "nice item" or "good condition" - be specific about what you observe
     - Create desire through factual description: let the item speak for itself
     - Stay truthful: Don't exaggerate, but highlight observable positives
     - Use UK English spelling and terminology
     - Vary sentence length for rhythm and readability
     - NEVER use emojis or emoji characters anywhere in the listing. Keep it clean, professional text only
     - Never mention AI, computer vision, or that the description was generated by an analysis—write as an objective observer describing what they see
     ...
     **EXAMPLES OF GOOD DESCRIPTIONS (Observer Tone):**

     * Jacket: "Nike Tech Fleece Jacket in size Large (Style: SP200710EAG). The garment displays Nike's signature Tech Fleece fabric - a lightweight, insulating material that appears soft and well-maintained. The black colourway appears consistent throughout with no visible fading. The jacket shows a modern fit with ribbed cuffs and hem in good condition. The zipper appears to function smoothly based on the photos provided. The overall condition appears to be excellent pre-owned with minimal signs of wear visible on the fabric.\n\nListed by https://www.quicklist.it.com"

     * Trainers: "Nike Air Jordan 1 Mid in UK Size 10 (Style: DM0029-100). The trainers display the classic Mid silhouette with leather uppers that show natural grain texture and some patina development. The white panels appear clean with visible contrast to the accent colours. The sole unit shows the original tread pattern with minimal wear visible on high-contact areas. The toe box displays slight creasing consistent with light use. The overall condition appears to be excellent with the materials looking well-maintained throughout.\n\nListed by https://www.quicklist.it.com"

     * Electronics: "Sony WH-1000XM4 Wireless Headphones in Black. The earcups appear to be in excellent condition with minimal visible wear to the padding. The headband shows good structural integrity with no apparent cracking or damage. The exterior surfaces appear clean with only light signs of handling. The charging port and buttons appear intact based on the photos provided. The overall condition suggests light use with the item appearing well-maintained.\n\nListed by https://www.quicklist.it.com"

     * Fragrance: "Acqua di Parma Colonia Intensa Eau de Cologne 100ml. The bottle appears to contain approximately 95% of the original volume based on the fill level visible. The label and cap show no visible damage or discolouration. The packaging appears intact with clean surfaces throughout. The fragrance appears to have been stored appropriately with no visible degradation to the liquid.\n\nListed by https://www.quicklist.it.com"
