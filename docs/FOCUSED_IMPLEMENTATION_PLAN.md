...
<select id="platformSelect">
    ...
    <option value="depop">Depop</option> <!-- NEW -->
</select>

<!-- Add Depop connect button -->
<button class="btn btn-secondary" onclick="app.connectDepop()">
    Connect Depop
</button>

<!-- Add Depop post button (similar to eBay) -->
<button class="btn btn-primary" id="depopPostBtn" onclick="app.postToDepop()" style="display: none;">
    Post to Depop
</button>
```
